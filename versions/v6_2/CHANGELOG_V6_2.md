...
V6.2 stabilise la proposition éditoriale et conceptuelle légère issue de V6.0.
...
- meilleure qualité des définitions abstraites centrales ;
- disparition des formes ciblées manifestement fautives ;
- conservation de la fermeture lexicale ;
- amélioration de la naturalité des tests conceptuels sans ouverture vers un nouveau domaine concret.

## Résultat

- taille stable : `1573` mots ;
- validation stricte : `1573/1573`, `0` mot hors vocabulaire ;
- validation conceptuelle : `300/300` phrases valides, `0` lourde, `0` impossible.
